...
const classes = computed(() =>
    props.active
        ? 'flex items-center px-5 py-2 rounded-lg border-gray-400 text-sm font-medium leading-5 text-gray-700 bg-gray-100 focus:outline-none focus:border-gray-700 transition duration-150 ease-in-out'
